...
-- CreateIndex
CREATE INDEX "FoodItem_userId_name_idx" ON "public"."FoodItem"("userId", "name");

-- CreateIndex
CREATE INDEX "Entry_userId_dateKey_idx" ON "public"."Entry"("userId", "dateKey");
...
-- AddForeignKey
ALTER TABLE "public"."Entry" ADD CONSTRAINT "Entry_foodItemId_fkey" FOREIGN KEY ("foodItemId") REFERENCES "public"."FoodItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;
